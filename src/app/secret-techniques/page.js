  ...
  return (
    <div className="font-sans flex flex-col bg-black text-yellow-400">
      ...
      <div className="md:grid grid-cols-2 grid-rows-3 justify-items-center md:m-[2vw]">
        <Technique imageSource="/Images/Force Drain.webp" imageAlt="Tryphowon draining the battery from a cellphone" title="Force Drain" description="Drain the energy from any life force. Make sure to get consent if you plan to use this on living organisms." price="$13,000.00"/>
        ...
        <Technique imageSource="/Images/Force Command.webp" imageAlt="A dog standing on its hind legs. Tryphowon is looking at it" title="Force Command" description="Imbue anything you touch, living or nonliving, with a command. Only works once per thing, per command. My old phone is still Googling “how many cups is 2 tablespoons” after 7 years." price="$7,000.00"/>
