  ...
  return (
    <div className="font-sans flex flex-col bg-black text-yellow-400">
      ...
      <div className="md:grid grid-cols-2 grid-rows-3 justify-items-center md:m-[2vw]">
        ...
        <Technique imageSource="/Images/Force Autochromia.png" imageAlt="A close-up of Tryphowon's eye" title="Force Autochromia" description="Use the chaotic wisdom of the dark side to change the color of your eyes. Popular among young Sith." price="$50.00"/>
